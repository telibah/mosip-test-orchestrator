package io.mosip.orchestrator.testrunner;
...
public class ExtractResource {
	...
	public static void extractResourceFromJar() {
		...
		getListOfFilesFromJarAndCopyToExternalResource("healthStatus.properties");
		getListOfFilesFromJarAndCopyToExternalResource("services.yaml");
