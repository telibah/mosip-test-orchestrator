...
import io.mosip.orchestrator.restassured.RestAssuredMethod;
...
public class PreRegistartionUtil {
	...
	public Response documentUpload(Response responseCreate, JSONObject request, String authToken,
		...
		String configPath = MosipTestRunner.getGlobalResourcePath() + "/preReg" + "/" + "documents";
	...
	public Response FetchCentre(String authToken) {
		...
		String preRegFetchCenterIDURI = preReg_FetchCenterIDURI + "10007";
	...
	public static JSONObject getRequest(String testSuite) {
		 ...
		 */
		String configPath = MosipTestRunner.getGlobalResourcePath() + "/preReg" + "/" + testSuite;
	...
	public Map<String, String> getProperty() {
		try {
			FileInputStream fi=new FileInputStream(new File(MosipTestRunner.getGlobalResourcePath()+"/preReg/config/preRegApi.properties"));
			prop.load(fi);
			fi.close();
